...
N_PHOTONS = 10000  # 每个顶点产生的光子数（固定）
MOMENTUM = 1.0  # 顶点动量 (MeV)

# 光学常数 - 修正为统一的 mm/ns 单位
N_LS = 1.48  # 液闪折射率
N_WATER = 1.33  # 水的折射率
C_0 = 299.792458  # 真空中光速 (mm/ns) - 修正
C_LS = C_0 / N_LS  # 液闪中光速 (mm/ns)
C_WATER = C_0 / N_WATER  # 水中光速 (mm/ns)
...
TARGET_PMT_ID = list(range(1500))  # 修改这个值：0=模拟PMT 0，None=模拟所有PMT
